...
import("theme.themes."..theme_name, function (t)
  if type(t) == "function" then
    ...
    Group.new("PmenuThumb", colours.t_bg_dark:light(), colours.t_bg_dark:light())
    ...
    Group.new("StatusLine", colours.t_fg, colours.t_bg_dark:light())
    ...
    -- bufferline
    Group.new("BufferLineOffsetSeparator", colours.t_bg_dark, colours.t_bg_dark)
    Group.new("BufferLineTabSeparatorSelected", colours.primary)
    ...
    -- scrollbar
    Group.new("ScrollbarHandle", nil, colours.grey:light())
  end
end)
